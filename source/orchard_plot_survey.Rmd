...
Table of papers with potential classical forest plots (to be re-evaluated to see if they are actually can be considered "classical" forest plots):     
...
*Figure 6. aggregation levels in surveyed papers relatively to papers with classical forest plots.*     
*Legend description (numbers of papers with at least one plot with given feature):*   
tax = papers with effect sizes aggregated to taxon level in the forest(-like) plots (N = `r length(papers_taxon)`)       
stu = papers with effect sizes aggregated to study level in the forest(-like) plots (N = `r length(papers_study)`)         
ind = papers with individual effect sizes presented in the forest(-like) plots (N = `r length(papers_individual)`)     
 ...
 **a)** 5 papers with classical-like forest plots but not showing the overall mean effect size in the same plot panel: ft037 (Fig. S4-3), ft084 (FigS1-S2), ft109(FigS9, FigS12-S14), ft148 (Fig10), ft181 (Fig2)     
