...
4.	What are the frequences of presenting of aggregated data in the forest plot at the study, taxon, or other levels? How often non-aggregated data is presented? [We expect few occurrences of “classical/real” forest plots (showing all individual effect sizes used in an meta-analysis, but note sometimes thes are equivalent to study-level aggregation if only one effect size per study was used); there should be studies with taxon-level aggregation, but "other aggregated" could dominate].   
...
From the list of the files ID's in the dataset we can see how many papers presented some kind of forest plot (see the Table below).
...
And a few other interesting plots (looking like orchard plot):   
- ft181  no (ft181_fig3.png, ft181_fig4.png)    
- ft096  no (ft096_fig2.png, ft096_S2.png, ft096_S2.png, ft096_S4.png)       
...
NEXT:   
- re-check  found "classical forest plots"